...
async fn handle_message(
    ...
    let config_info = common::SpdmConfigInfo {
        ...
        base_asym_algo: if rsp_emu_use_ecdsa() {
        ...
        req_asym_algo: if rsp_emu_use_ecdsa() {
    ...
    if let Some(chain_path) = cert_chain_path {
        ...
        let ca_file_path = if rsp_emu_use_ecdsa() {
        ...
        let inter_file_path = if rsp_emu_use_ecdsa() {
        ...
        let leaf_file_path = if rsp_emu_use_ecdsa() {
