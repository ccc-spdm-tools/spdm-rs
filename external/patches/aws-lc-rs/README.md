...
These patches provide the freestanding and algorithm-scoped AWS-LC profile
used by `spdmlib_crypto_aws_lc`.
...
git -C aws-lc-sys/aws-lc apply --unidiff-zero \
  ../../../patches/aws-lc-rs/aws-lc/0001-build-support-freestanding-algorithm-scoped-profiles.patch
git apply --unidiff-zero \
  ../patches/aws-lc-rs/0001-feat-aws-lc-rs-support-freestanding-algorithm-profil.patch
```
