...
pub const MAX_MANAGED_BUFFER_A_SIZE: usize = 300;
pub const MAX_MANAGED_BUFFER_B_SIZE: usize =
    40 + (SPDM_MAX_HASH_SIZE + 4) * SPDM_MAX_SLOT_NUMBER + config::MAX_SPDM_CERT_CHAIN_DATA_SIZE;
pub const MAX_MANAGED_BUFFER_C_SIZE: usize =
    90 + SPDM_MAX_HASH_SIZE * 2 + SPDM_MAX_ASYM_SIG_SIZE + MAX_SPDM_OPAQUE_SIZE;
pub const MAX_MANAGED_BUFFER_M_SIZE: usize = 63
    + SPDM_NONCE_SIZE
...
pub const MAX_MANAGED_BUFFER_F_SIZE: usize =
    12 + SPDM_MAX_HASH_SIZE * 2 + SPDM_MAX_ASYM_SIG_SIZE + MAX_SPDM_OPAQUE_SIZE * 2;
